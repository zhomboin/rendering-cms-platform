...
upsert_env "S3_PUBLIC_BASE_URL" "http://$BROWSER_ACCESS_HOST:$MINIO_PORT/rendering-assets"
...
echo "S3_PUBLIC_BASE_URL=http://$BROWSER_ACCESS_HOST:$MINIO_PORT/rendering-assets"
